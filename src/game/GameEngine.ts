...
export class GameEngine {
  ...
  getPublicState(): PublicGameState {
    return {
      ...
      winnerPlayerId: this.state.resultsRevealed ? this.state.winnerPlayerId : undefined,
      winnerResourceType: this.state.resultsRevealed ? this.state.winnerResourceType : undefined,
