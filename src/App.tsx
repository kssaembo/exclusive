...
export default function App() {
  ...
  return <><ButtonClickAudio />{lobbyRoute && <BackgroundAudio src={audioFiles.lobby} label="BGM" />}<Routes><Route path="/" element={<HomePage />} /><Route path="/intro" element={<LearningIntroPage />} /><Route path="/rules" element={<RulesPage />} /><Route path="/setup" element={<SetupPage />} /><Route path="/host" element={<HostPage />} /><Route path="/board" element={<BoardPage />} /><Route path="/cards" element={<CardViewerPage />} /><Route path="/station" element={<StationPage />} /><Route path="*" element={<Navigate to="/" replace />} /></Routes></>
}
